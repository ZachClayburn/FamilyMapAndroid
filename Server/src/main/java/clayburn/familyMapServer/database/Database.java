...
public class Database {
    ...
    public void openConnection() throws DatabaseException {
        ...
        try {
            final String CONNECTION_URL = "jdbc:sqlite:Server/src/clayburn/familyMapServer/familyMap.sqlite";
    ...
    static private final String mainPath = "Server/src/clayburn/familyMapServer/familyMap.sqlite";
    static private final String backUpPath = "Server/src/clayburn/familyMapServer/familyMapBackup.sqlite";
